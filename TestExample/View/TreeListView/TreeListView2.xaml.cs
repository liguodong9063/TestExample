...
{
    /// <summary>
    /// TreeListView2.xaml 的交互逻辑
    /// </summary>
    public partial class TreeListView2
    {
    ...
    public class RowTemplateSelector2 : DataTemplateSelector
    {
        public DataTemplate ParentRowTemplate { get; set; }
        public override DataTemplate SelectTemplate(object item, DependencyObject container)
        {
            var row = item as RowData;
            var rowData = (TreeListView2.TestObject)row.Row;
